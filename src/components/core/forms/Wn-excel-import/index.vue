<!-- Excel导入组件：读取Excel文件并解析为JSON数据，支持xlsx和xls格式 -->
<template>
  <div class="inline-block">
    <ElUpload :autoUpload="false" accept=".xlsx, .xls" :showFileList="false" @change="handleFileChange">
      <ElButton type="primary" v-ripple><slot>导入 Excel</slot></ElButton>
    </ElUpload>
  </div>
</template>
