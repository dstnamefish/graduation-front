<!-- 表格操作按钮组件：用于表格行内的快捷操作按钮，支持预设类型和自定义样式 -->
<template>
  <div :class="['inline-flex items-center justify-center min-w-8 h-8 px-2.5 mr-2.5 text-sm c-p rounded-md', buttonClass]" :style="{ backgroundColor: props.buttonBgColor, color: props.iconColor }" @click="handleClick">
