...
import type {
  CreateDepartmentParams as CreateDepartmentRequest,
  UpdateDepartmentParams as UpdateDepartmentRequest,
  GetDepartmentParams,
  DepartmentResponse,
  DepartmentListResponse,
  CreateSpecialtyParams as CreateSpecialtyRequest,
  UpdateSpecialtyParams as UpdateSpecialtyRequest,
  GetSpecialtyParams,
  SpecialtyResponse,
