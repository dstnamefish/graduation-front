...
<template>
  <div class="w-full">
    ...
    <ElTabs v-model="activeTab" class="auth-tabs mb-6" stretch>
      <ElTabPane :label="t('auth.forgotPassword.emailTab')" name="email">
        <ElForm ref="emailFormRef" :model="emailForm" :rules="emailRules" labelPosition="top" size="large">
          <ElFormItem :label="t('auth.forgotPassword.emailAddress')" prop="email" class="mb-5">
            <ElInput v-model="emailForm.email" :placeholder="t('auth.forgotPassword.emailPlaceholder')" />
          </ElFormItem>

          <ElFormItem :label="t('auth.forgotPassword.verificationCode')" prop="code" class="mb-5">
            <div class="flex gap-2 w-full">
              <ElInput v-model="emailForm.code" :placeholder="t('auth.forgotPassword.codePlaceholder')" class="flex-1" />
              <ElButton type="primary" :disabled="emailCountdown > 0" class="w-32" @click="sendEmailCode">
      ...
      <ElTabPane :label="t('auth.forgotPassword.phoneTab')" name="phone">
        <ElForm ref="phoneFormRef" :model="phoneForm" :rules="phoneRules" labelPosition="top" size="large">
          <ElFormItem :label="t('auth.forgotPassword.phoneNumber')" prop="phone" class="mb-5">
            <ElInput v-model="phoneForm.phone" :placeholder="t('auth.forgotPassword.phonePlaceholder')" />
          </ElFormItem>

          <ElFormItem :label="t('auth.forgotPassword.verificationCode')" prop="code" class="mb-5">
            <div class="flex gap-2 w-full">
              <ElInput v-model="phoneForm.code" :placeholder="t('auth.forgotPassword.codePlaceholder')" class="flex-1" />
              <ElButton type="primary" :disabled="phoneCountdown > 0" class="w-32" @click="sendPhoneCode">
    ...
    <ElForm ref="passwordFormRef" :model="passwordForm" :rules="passwordRules" labelPosition="top" size="large" class="mb-6">
      <ElFormItem :label="t('auth.forgotPassword.newPassword')" prop="password" class="mb-5">
        <ElInput v-model="passwordForm.password" type="password" :placeholder="t('auth.forgotPassword.newPasswordPlaceholder')" showPassword />
      </ElFormItem>
      <ElFormItem :label="t('auth.forgotPassword.confirmNewPassword')" prop="confirmPassword" class="mb-8">
        <ElInput v-model="passwordForm.confirmPassword" type="password" :placeholder="t('auth.forgotPassword.confirmNewPasswordPlaceholder')" showPassword />
      </ElFormItem>

      <ElButton type="primary" class="w-full h-12" @click="handleReset">
