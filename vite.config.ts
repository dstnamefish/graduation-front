...
export default ({ mode }: { mode: string }) => {
  ...
  return defineConfig({
    ...
    server: {
      ...
      host: true,
      hmr: {
        clientPort: Number(VITE_PORT) || 3006,
      },
      warmup: {
    ...
    resolve: {
      alias: {
        ...
        '@imgs': fileURLToPath(new URL('./src/assets', import.meta.url)),
      },
    },
    build: {
      target: 'esnext',
    ...
    plugins: [
      ...
      AutoImport({
        ...
        dirs: ['./src/hooks/**', './src/utils/**', './src/views/**/composables'],
      ...
      Components({
        ...
        resolvers: [ElementPlusResolver()],
        dirs: ['src/components/core', 'src/components'],
        extensions: ['vue'],
        deep: true,
      }),
      ElementPlus({
